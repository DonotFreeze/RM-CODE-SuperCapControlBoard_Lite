...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, CAP_CTRL_Pin|LED_GREEN_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, TIM1_Break_CTRL_Pin|TEST_OUT_Pin|LED_BLUE_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = CAP_CTRL_Pin|LED_GREEN_Pin;
  ...
  GPIO_InitStruct.Pin = TIM1_Break_CTRL_Pin|TEST_OUT_Pin|LED_BLUE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
