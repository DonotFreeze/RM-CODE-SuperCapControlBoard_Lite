...
#define TEMP_CAP_Pin GPIO_PIN_0
#define TEMP_CAP_GPIO_Port GPIOA
#define Ibat_Pin GPIO_PIN_2
#define Ibat_GPIO_Port GPIOA
#define Icap_Pin GPIO_PIN_3
#define Icap_GPIO_Port GPIOA
#define CAP_CTRL_Pin GPIO_PIN_5
#define CAP_CTRL_GPIO_Port GPIOA
#define Vboost_Pin GPIO_PIN_6
#define Vboost_GPIO_Port GPIOA
#define Vbat_Pin GPIO_PIN_7
#define Vbat_GPIO_Port GPIOA
#define Vcap_Pin GPIO_PIN_0
